    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_owner', models.BooleanField(default=False, help_text='Designates whether the profile is from account owner.', verbose_name='owner status')),
                ...
                ('can_manage', models.BooleanField(verbose_name='can manage')),
                ('can_attend', models.BooleanField(verbose_name='can attend')),
                ('can_buy', models.BooleanField(verbose_name='can buy')),
                ('accountable', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='profiles', to=settings.AUTH_USER_MODEL)),
            ],
            options={
