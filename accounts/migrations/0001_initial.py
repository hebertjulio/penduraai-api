    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_owner', models.BooleanField(db_index=True, default=False, verbose_name='owner status')),
                ('is_manager', models.BooleanField(db_index=True, default=False, verbose_name='manager status')),
                ('is_attendant', models.BooleanField(db_index=True, default=False, verbose_name='attendant status')),
