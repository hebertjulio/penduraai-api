    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('done', 'done'), ('fail', 'fail')], db_index=True, max_length=30, verbose_name='status')),
                ...
                ('signature', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='signature', to='accounts.Profile')),
            ],
            options={
